      ...
      <div className="i-fomulario-mascota-encontrada">
        <div class="i-datos-mascota-encontrada">
          ...
          <div className="i-datos-lado-mascota-encontrada">
            <label className="i-datos-texto-mascota-encontrada" for="fnombre">
              Especie{" "}
              <div className="tooltip">
                *
                <span className="tooltiptext">
                  Escriba la especie del animal encontrado (ejemplo: perro,
                  gato, ave, etc.)
                </span>
              </div>{" "}
              :
            ...
            <input
              className="i-caja-mascota-mencontrada"
              type="text"
              name="especie"
              id="especiea"
            />
            ...
            <label className="i-datos-texto-mascota-encontrada" for="fnombre">
              Fecha de hallazgo<a href="./">(DD/MM/AA)</a>:
            </label>
            <input
              className="i-caja-mascota-mencontrada"
              type="date"
        ...
        <div className="i-informacion-contenedo-mascota-encontrada">
          <div className="i-informacion-zona">
            <label className="i-datos-texto-mascota-encontrada" for="fnombre">
              Departamento<a href="./">*</a>:
            </label>
            <input
              className="i-caja-datos-zona"
              type="text"
              name="especie"
              id="especiea"
            />
